...
ronflex = Pokemon.new({name: "Ronflex", special_capacity: "Ronfffff....lex", category: "Earth", description: "Sleep all the time", address: "25 rue Trousseau, Paris"})
ronflex.user = julien
ronflex.save!
file = URI.open("https://www.123-stickers.com/7455-7873-large/Array.jpg")
ronflex.photo.attach(io: file, filename: ronflex.name)

chenipan = Pokemon.new({name: "Chenipan", special_capacity: "None", category: "Insect", description: "Good friend, peaceful and quiet", address: "15 rue Voltaire, Paris"})
chenipan.user = nico
chenipan.save!
...
mew = Pokemon.new({name: "Mew", special_capacity: "Can destroy everything", category: "Psy", description: "Hard to find...", address: "Gare de Lyon, Paris"})
mew.user = antho
mew.save!
...
metamorph = Pokemon.new({name: "Metamorph", special_capacity: "Imposter", category: "Morphing", description: "A chewing gum who change into anything", address: "14 boulevard Barbes, Paris"})
...
lokhlass = Pokemon.new({name: "Lokhlass", special_capacity: "Laser beam", category: "Water", description: "Looks a lot like Dianita", address: "3 rue du Regard, Paris"})
lokhlass.user = nico
lokhlass.save!
file = URI.open("https://www.123-stickers.com/7443-7861-large/Array.jpg")
lokhlass.photo.attach(io: file, filename: lokhlass.name)

oh_oh = Pokemon.new({name: "Ho-Oh", special_capacity: "Unknown", category: "Legendary", description: "Legends only say he exists", address: "32 rue Gauthey, Paris"})
oh_oh.user = nico
oh_oh.save!
...
miaouss = Pokemon.new({name: "Miaouss", special_capacity: "Scratch", category: "Earth", description: "Team Rocket modafak", address: "32 rue de la Fédération, Paris"})
miaouss.user = julien
miaouss.save!
file = URI.open("https://www.123-stickers.com/7327-7722-large/Array.jpg")
miaouss.photo.attach(io: file, filename: miaouss.name)

kicklee = Pokemon.new({name: "Kicklee", special_capacity: "Fire kick", category: "Combat", description: "Don't piss him off", address: "10 rue de la Paix, Paris"})
kicklee.user = julien
kicklee.save!
file = URI.open("https://www.123-stickers.com/7418-7836-large/Array.jpg")
kicklee.photo.attach(io: file, filename: kicklee.name)

pikachu = Pokemon.new({name: "Pikachu", special_capacity: "Thunder", category: "Electric", description: "Shocking cute, so be careful!", address: "20 rue du Transvaal, Paris"})
pikachu.user = raph
pikachu.save!
file = URI.open("https://www.123-stickers.com/7300-7694-thickbox/Array.jpg")
pikachu.photo.attach(io: file, filename: pikachu.name)

dracoloss = Pokemon.new({name: "Dracoloss", special_capacity: "Ultralaser", category: "Dragoon", description: "One of the most powerful", address: "12 rue de Seine, Paris"})
dracoloss.user = nico
dracoloss.save!
file = URI.open("https://www.123-stickers.com/7461-7879-large/Array.jpg")
dracoloss.photo.attach(io: file, filename: dracoloss.name)

bulbizarre = Pokemon.new({name: "Bulbizarre", special_capacity: "Para Spore", category: "Grass", description: "Not a bad starter", address: "8 rue Juliette Recamier, Paris"})
